...
#plink --vcf data/output/called/stringent_vcf/all_chrom_SNP_stringent.vcf.gz --make-bed --chr-set 1 no-xy --allow-extra-chr --geno 0 --mind 0.2 --maf 0.05 --out data/output/called/stringent_bed/all_chrom_SNP_stringent_mind2